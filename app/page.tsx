      ...
      <footer className="border-t border-ink/10 bg-[#FBF9F5] px-6 py-8 md:px-10">
        <div className="mx-auto flex max-w-[86rem] flex-wrap items-center justify-between gap-x-8 gap-y-3 text-[0.72rem] text-ink/40">
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-1">
            <Link href="/business/packages" className="transition-colors hover:text-ink">Business content</Link>
            <span aria-hidden>·</span>
            <Link href="/business/subscriptions" className="transition-colors hover:text-ink">Subscriptions</Link>
            <span aria-hidden>·</span>
            <Link href="/corporate" className="transition-colors hover:text-ink">Corporate events</Link>
          </div>
          <div className="flex flex-wrap items-center gap-x-5 gap-y-1">
