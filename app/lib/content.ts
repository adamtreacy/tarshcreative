...
export const weddingPackages: Package[] = [
  {
    ...
    features: [
      ...
      "1x 30 to 60 second ceremony video (within 72 hrs)",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Full ceremony and speeches with professional audio (within 72 hrs)",
      "1x 30 second sneak peek (within 24 hrs)",
      "Highlight video of the entire day (within 72 hrs)",
      "2x moment reels",
